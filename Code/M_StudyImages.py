...
if args.Type=='Val':
 input_file_location=EOS_DIR+'/ANNDEA/Data/TRAIN_SET/'+TrainSampleID+'_VAL_TRACK_SEEDS_OUTPUT.pkl'
else:
...
ImageObjectSet[1].PrepareSeedPrint(DummyModelObj)
ImageObjectSet[1].Plot('XZ')
exit()
if args.PlotType=='XZ':
  InitialData=[]
  Index=-1
