...
if Mode=='RESET':
    print(UI.ManageFolders(AFS_DIR, EOS_DIR, RecBatchID,'d',['RTr1a','RTr1b','RTr1c','RTr1d','RTr1e','RTr1f']))
...
while Status<len(Program):
    if Program[Status]!='Custom':
      ...
      #try:
        ...
        Bad_Tracks_CP_File=EOS_DIR+'/ANNDEA/Data/REC_SET/'+RecBatchID+'/Temp_RTr1f_'+RecBatchID+'_0'+'/RTr1f_'+RecBatchID+'_Bad_Tracks_CP.csv'
