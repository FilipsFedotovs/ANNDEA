...
if Mode=='RESET':
 ...
 if ModelType=='CNN':
    Job=UF.CreateCondorJobs(AFS_DIR,EOS_DIR,'/ANNADEA/Data/TRAIN_SET/','N/A','N/A','N/A',TrainSampleID,[1],OptionHeader,OptionLine,'MUTr2_TrainModel_Sub.py',batch_sub=False,Exception=['',''], Log=True, GPU=True)[0]
 else:
    Job=UF.CreateCondorJobs(AFS_DIR,EOS_DIR,'/ANNADEA/Data/TRAIN_SET/','N/A','N/A','N/A',TrainSampleID,[1],OptionHeader,OptionLine,'MUTr2_TrainModel_Sub.py',batch_sub=False,Exception=['',''], Log=True, GPU=False)[0]
 print(Job)
 exit()
 TrainSampleInputMeta=EOS_DIR+'/ANNADEA/Data/TRAIN_SET/'+TrainSampleID+'_info.pkl'
 print(UF.TimeStamp(),'Loading the data file ',bcolors.OKBLUE+TrainSampleInputMeta+bcolors.ENDC)
