...
hitdata['tx'] = pd.to_numeric(ANN_test['tx'],errors='coerce').fillna(0.00).astype('float')
hitdata['ty'] = pd.to_numeric(ANN_test['ty'],errors='coerce').fillna(0.00).astype('float')
