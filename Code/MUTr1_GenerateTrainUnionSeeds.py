...
prog_entry.append([AFS_DIR,EOS_DIR,PY_DIR,'/ANNDEA/Data/TRAIN_SET/'+TrainSampleID+'/','RefinedSeeds','MUTr1b','.pkl',TrainSampleID,Meta.JobSets[0],'MUTr1b_RefineSeeds_Sub.py'])
