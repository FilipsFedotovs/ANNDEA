...
FirstFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1b_'+RecBatchID+'_hit_cluster_rec_z_set_'+str(0)+'_' +str(X_ID)+'.pkl'
...
for i in range(1,Y_ID_Max):
    SecondFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1b_'+RecBatchID+'_hit_cluster_rec_z_set_'+str(i)+'_' +str(X_ID)+'.pkl'
...
OutputFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1c_'+RecBatchID+'_hit_cluster_rec_y_set_' +str(X_ID)+'.pkl'
