...
def main(self):
    ...
    if ModelMeta.ModelType=='CNN':
        ...
        for epoch in range(0, TrainParams[2]):
            ...
            print([epoch,itr,train_loss[0],0.5,val_loss,val_loss,test_loss,test_loss,train_set])
            records.append([epoch,itr,train_loss[0],0.5,val_loss,val_loss,test_loss,test_loss,train_set])
