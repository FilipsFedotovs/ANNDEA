...
HC.GenerateSeeds(cut_dt, cut_dr, cut_dz, -1, -1, SeedFlowLog,ModelName) #Creating Hit Cluster graph (using PyTorch Graph calss). We add Labels too sicnce it is Train data
