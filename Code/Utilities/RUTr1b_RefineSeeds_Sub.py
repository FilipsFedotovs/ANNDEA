...
input_segment_file_location=EOS_DIR+'/ANNADEA/Data/REC_SET/RUTr1_'+BatchID+'_TRACK_SEGMENTS.csv'
input_track_file_location=EOS_DIR+'/ANNADEA/Data/REC_SET/RUTr1a_'+BatchID+'_SelectedSeeds_'+str(i)+'_'+str(j)+'_'+str(k)+'.csv'
