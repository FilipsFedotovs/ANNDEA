...
FirstFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1c_'+RecBatchID+'_hit_cluster_rec_y_set_' +str(0)+'.pkl'
...
for i in range(1,X_ID_Max):
    SecondFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1c_'+RecBatchID+'_hit_cluster_rec_y_set_'+str(i)+'.pkl'
...
OutputFile=EOS_DIR+'/ANNDEA/Data/REC_SET/RH1d_'+RecBatchID+'_hit_cluster_rec_x_set.pkl'
