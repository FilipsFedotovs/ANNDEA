...
FirstFile=EOS_DIR+'/EDER-GNN/Data/REC_SET/RH1a_'+RecBatchID+'_hit_cluster_rec_set_'+str(0)+'_' +str(Y_ID)+'_' +str(X_ID)+'.pkl'
...
for i in range(1,Z_ID_Max):
    SecondFile=EOS_DIR+'/EDER-GNN/Data/REC_SET/RH1a_'+RecBatchID+'_hit_cluster_rec_set_'+str(i)+'_' +str(Y_ID)+'_' +str(X_ID)+'.pkl'
...
OutputFile=EOS_DIR+'/EDER-GNN/Data/REC_SET/RH1b_'+RecBatchID+'_hit_cluster_rec_z_set_'+str(Y_ID)+'_' +str(X_ID)+'.pkl'
